...
using WebTourAPI.Entities;
using WebTourAPI.Models;

namespace WebTourAPI.Controllers
{
    public class HotelsController : ApiController
    {
        ...
        // GET: api/Hotels
        [ResponseType(typeof(List<RHotel>))]
        public IHttpActionResult GetHotels()
        {
            return Ok(db.Hotel.ToList().ConvertAll(p => new RHotel(p)));
        }
